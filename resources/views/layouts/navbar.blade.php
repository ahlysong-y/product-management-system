                ...
                @auth
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0 mt-2 rounded-3"
                            ...
                            <li class="px-2">
                                <a class="dropdown-item rounded" href="{{ route('profile.edit') }}">👤 Profile</a>
                            </li>
                    ...
                    <form method="POST" action="{{ route('logout') }}" class="m-0 p-0">
                        @csrf
                        <button type="submit"
                            class="btn btn-danger btn-sm d-flex align-items-center gap-1 rounded-pill px-3 shadow-sm border-0">
